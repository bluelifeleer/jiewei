 ...
 * 必选参数
 */
$InitPHP_conf['url'] = 'http://api.zj3w.net/';
/*
 *    静态资源CDN
 */
...
$InitPHP_conf['controller']['default_module']        = 'test'; //默认执行module
...
/*********************************Error*****************************************/
$InitPHP_conf['sms']['sms_uid']   = 300872;
$InitPHP_conf['sms']['productid'] = 5720;
$InitPHP_conf['sms']['sms_key']   = c336302222b2df9da2a129d6fefb0210;
