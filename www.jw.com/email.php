...
<html>
	...
	<body>
    	<!-- page 容器 -->
		<div class="page" id="page-modif" data-page-fn="email">
			<!-- 标题栏 -->
			...
			<div class="content pad15">
				<input class="w100b bor1 bce6 bgfff pad10" id="email" type="text" placeholder="输入邮箱">
				<p data-modif-type="email" id="modif-but" class="block mar0 mart10 borrad5 marauto white w100b h50 lh50 txac bgfa6a0b" style="line-height:50px;cursor:pointer;">保存</p>
			</div>
		</div>
	</body>
