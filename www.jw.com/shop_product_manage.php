...
<html>
    ...
    <body>
      <!-- page 容器 -->
      <div class="page" id="page-shop-product-manage">

      <!-- 标题栏 -->
      <header class="bar bar-nav">
          <a class="pull-left back" data-no-cache="true" href="shop_manager.php">
          ...
          <a class="pull-right" data-no-cache="true" href="shop_product_add.php">
            <i class="icon iconfont mar0 white" style="font-size: 16px;cursor: pointer;">新增</i>
          </a>
    ...
    <div class="content infinite-scroll">
            ...
            <div class="infinite-scroll-preloader ">
                    ...
                    <div class="preloader_null disn fs06">没有对应的商品！</div>
            </div>
    </div>
    </div>
    </body>
