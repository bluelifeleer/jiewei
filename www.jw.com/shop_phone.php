    ...
    <!-- page 容器 -->
        ...
        <a class="pull-left back " href="shop_manager.php">
			...
			<nav class="bar bar-tab">
				<span class="toools-bar-but tab-item active" style="cursor:pointer;" id="shop-index" data-but-type="index">
        ...
        <div id="shop-phone" contenteditable="true" class="block w90b h100 bgfff marauto mart20 bor1 bcc1c1c1 c8F8F90">请输入手机号</div>
      </div>
    </div>
  </body>
