...
<html>
	...
	<body>
    	<!-- page 容器 -->
		<div class="page" id="page-find-password">
			<!-- 标题栏 -->
			...
			<div class="content pad15">
				<input class="w100b bor1 bce6 bgfff pad10" id="phone" type="text" placeholder="请输入手机号">
				<p class="mar0 mart10"><a class="button button-big button-fill external" style="background:#04980B" id="send-new-pasd-but" href="javascript:void(0);">发送(60s)</a></p>
			</div>
		</div>
	</body>
