...
<html>
	...
	<body>
    	<!-- page 容器 -->
		<div class="page" id="page-modify-password">
			<!-- 标题栏 -->
			<header class="bar bar-nav">
				<a class="pull-left back " href="safety.php">
			...
			<div class="content">
				<div class="page-login">
					<div class="list-block mar15 borl1 borr1 bce6">
						<ul>
							<li class="borb1 bce6">
								<input id="original-pasd" type="password" value="" placeholder="原密码">
							</li>
							<li class="borb1 bce6">
								<input id="new-pasd" type="password" value="" placeholder="新密码">
							</li>
							<li>
								<input id="confirm-pasd" type="password" value="" placeholder="确认新密码">
							</li>
						</ul>
					</div>
					<div class="list-block mar15">
						<span id="modify-pasd-but" class=" block w100b h50 lh50 white txalc bgfa6a0b pad0 borrad5 marauto">修改</span>
					</div>
				</div>
			</div>
		</div>
