...
<html lang="en">
    ...
    <body>
        <div class="page" id="shop-category-add">
            <header class="bar bar-nav">
                <a class="pull-left back" href="shop_category_manage.php" data-no-cache="true">
            ...
            <div class="content bgfff">
                <div class="padl5 padr5" id="classify">
                    <div class="w100b h50 lh50 borb1 bce6">
                        <span class="icon icon-form-name">请添加您的商品分类:</span>
                    ...
                    <div data-parentid="0" data-catid="1"  id="category_1" class="add_category w100b h50 lh50 borb1 bce6" style="display:;">
                        ...
                        分类名：　<input type="text" class="add-create-categories bor0" data-parentid="0" value="" data-catid="1" placeholder="请在这里填写您的分类">
                        </div>
                        <div class="clear"></div>
                    </div>
