...
<html>
    ...
    <body>
        <!-- page 容器 -->
        <div class="page" id="page-shop-msg-list">
            <!-- 标题栏 -->
            ...
            <div class="content bgEEEEEE">
             ...
             <div class="content-block-title" style="margin-top: .75rem;">店铺消息</div>              
                    <div class="list-block media-list">
                      <ul class="shop-msg-list">
                        
                      
                      </ul>
                    </div>

                    <!--   <div class="content-block-title" style="margin-top: .75rem;">其他消息</div> -->              
                    <div class="list-block media-list">
                   <!--    <ul>
                        <li>
