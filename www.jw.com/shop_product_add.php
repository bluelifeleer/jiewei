    ...
    <body>
        ...
        <div class="page" id="page-product-add">
            ...
            <header class="bar bar-nav">
                <a class="pull-left back" data-no-cache="true" href="shop_product_manage.php">
            ...
            <div class="content bgEEEEEE">
                ...
                <div class="w100b bgfff">
                    ...
                    <a href="shop_product_create.php" id="shop-product-create" class="c3D4145">
                    ...
                    <a href="shop_manage_add.php" class="c3D4145 external">
                    <div class="edit-shop-info-title w100b h50 lh50 borb1 bcc1c1c1">
