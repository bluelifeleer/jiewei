...
<html>
    ...
    <body>
        <!-- page 容器 -->
        <div class="page" id="page-shop-order-manage">
            <!-- 标题栏 -->
            <header class="bar bar-nav">
                <h1 class="title" id="order-page-title">店铺订单</h1>
                <a class="pull-left " href="shop_manager.php">
            ...
            <div class="w100b pos-a borb1 bce6" style="position:absolute;top:2.2rem;z-index:99999;">
                <div class="row no-gutter txac bgfff fs06">
                        <div class="order-page-bf col-20 padt8 padb8 borb2 bcfff mar0" style="width:16.66666%">
                            <a class="c333 external" href="shop_order.php?order_type=">全部</a></div>
                        <div class="order-page-bf col-20 padt8 padb8 borb2 bcfff" style="width:16.66666%">
                            <a class="c333 external" href="shop_order.php?order_type=1">待付款</a>
                        </div>
                        <div class="order-page-bf col-20 padt8 padb8 borb2 bcfff" style="width:16.66666%">
                            <a class="c333 external" href="shop_order.php?order_type=2">待发货</a>
                        </div>
                        <div class="order-page-bf col-20 padt8 padb8 borb2 bcfff" style="width:16.66666%">
                            <a class="c333 external" href="shop_order.php?order_type=3">已发货</a>
                        </div>
                        <div class="order-page-bf col-20 padt8 padb8 borb2 bcfff" style="width:16.66666%">
                            <a class="c333 external" href="shop_order.php?order_type=4">已收货</a>
                        </div>
                        <div class="order-page-bf col-20 padt8 padb8 borb2 bcfff" style="width:16.66666%">
                            <a class="c333 external" href="shop_order.php?order_type=6">售后</a>
                        </div>
                    </div>
                </div>
            <!-- 工具栏 -->
            ...
            <div class="content pull-to-refresh-content infinite-scroll" data-distance="100" style="margin-top:38px;">
                <!-- 默认的下拉刷新层 -->
