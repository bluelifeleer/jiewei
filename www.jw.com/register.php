	...
	<body>
		...
		<div class="page" id="page-register">
			...
			<header class="bar bar-nav">
				<h1 class="title"><a class="external" href="/sources/js/module/public.js">免费注册<a></h1>
				<a class="pull-left back " href="login.php">
					<i class="icon iconfont mar0 fs13 white">&#xe61b;</i>
				</a>
			</header>
			<div class="content pad15">
				<input class="w100b bor1 bce6 bgfff pad10" id="phone" type="number" placeholder="手机号">
				<span id="tcp" class="w100b h30 lh30" style="display:none">手机号必须是非字母的11位数字</span>
				<p class="w100b h40 mar0 mart10">
					<input type="number" value="" id="input-verification-code-box" class="block fll w60b h40 lh40 bor1 bce6 padl10" style="box-sizing:border-box" placeholder="输入获取到的短信验证码" />
					<span class="block fll w40b h40 lh40 fs07 txac bg04980B white" data-is-send="true" id="send-valiDate-code-but">发送验证码(60)</span>
				</p>
				<p class="mar0 mart10"><span id="next-but" class="block w100b h50 lh50 txac white borrad6 bgfa6a0b ">下一步</span></p>
