...
<html>
	...
	<body>
		<div class="page" id="page-leter-list">
      <header class="bar bar-nav bgFA6A0B">
        <a class="pull-left back" href="letter_box.php">
			...
			<!--内容区-->
			<div class="content">
				<ul id="msg-list-block">
					<li>
							<a href="" class="tab-item  c3D4145">
							<div class="content-block-title txalc">刚刚</div>
							<div class="card pad10">
								<div class="card-head"></div>
								<div class="card-content">
									<div class="card-content-title">10.0元红包君到帐了</div>
									<div class="card-inner">微软surface精品店返给您的10.0元1212现金红包，淘宝天猫无门槛通用，可与其他优惠券叠加，赶紧去花掉TA吧！</div>
								</div>
								<div class="card-footer"><span class="inlineblock txalr wrem58">查看详情</span><span class="icon icon-right"></span></div>
							</div>
						</a>
					</li>
					<li>
							<a href="" class="tab-item  c3D4145">
							<div class="content-block-title txalc">14分钟前</div>
							<div class="card pad10">
								<div class="card-head"></div>
								<div class="card-content">
									<div class="card-content-title">订单已发货！您购买的[微软surface/Mi...</div>
									<div class="list-block media-list">
										<div class="card-inner">
											<div class="item-content">
												<div class="item-media"><img src="/sources/images/TB1qj1EKVXXXXbiXXXXXXXXXXXX_!!0-item_pic.jpg_60x60q90.jpg" class="w60 h60 bor0" /></div>
												<div class="item-inner">
													<div class="item-text">订单已发货！您 购买的[微软surface/Microsoft Surface拓展坞底坐Pro4 3 Book dock正品扩展坞]已发货,快递单号920406396587</div>
												</div>
											</div>
										</div>
									</div>
					...
					<li>
							<a href="" class="tab-item  c3D4145">
							<div class="content-block-title txalc">16:28</div>
							<div class="card pad10">
								<div class="card-head"></div>
								<div class="card-content">
									<div class="card-content-title">10.0元红包君到帐了</div>
					...
					<li>
							<a href="" class="tab-item  c3D4145">
							<div class="content-block-title txalc">2015年05月20日</div>
							<div class="card pad10">
								<div class="card-head"></div>
								<div class="card-content">
									<div class="card-content-title">10.0元红包君到帐了</div>
					...
					<li>
							<a href="" class="tab-item  c3D4145">
							<div class="content-block-title txalc">2015年06月20日</div>
							<div class="card pad10">
								<div class="card-head"></div>
								<div class="card-content">
									<div class="card-content-title">10.0元红包君到帐了</div>
					...
					<li>
							...
							<div class="card pad10">
								<div class="card-head"></div>
								<div class="card-content">
									<div class="card-content-title">订单已发货！您购买的[Canon/佳能 70D...</div>
									<div class="list-block media-list">
										<div class="card-inner">
											<div class="item-content">
												<div class="item-media"><img src="/sources/images/TB1MamsJpXXXXX1XFXXXXXXXXXX_!!0-item_pic.jpg_400x400.jpg" class="w60 h60 bor0" /></div>
												<div class="item-inner">
													<div class="item-text">订单已发货！您购买的[Canon/佳能 70D (18-135 STM)佳能数码单反 70D套机相机]已发货,快递单号920406396587</div>
												</div>
											</div>
										</div>
									</div>
					...
					<li>
							<a href="" class="tab-item  c3D4145">
							<div class="content-block-title txalc">2015年05月10日</div>
							<div class="card pad10">
								<div class="card-head"></div>
								<div class="card-content">
									<div class="card-content-title">10.0元红包君到帐了</div>
