...
define("WECHAT_URL", 'http://api.zj3w.net/');
define('WECHAT_TOKEN', 'yunsoft');
define('ENCODING_AES_KEY', "sREc8xeTnpsOhDDqwVJ8GIxYVCiSRKhhr7neHDFnUYF");
define("WECHAT_APPID", 'wx34fdd0d60e7d4514');
define("WECHAT_APPSECRET", '428144f61ac3753970c581c781e6d9e5');

/*
 * 开发者配置
*/
// define("WECHAT_URL", $site_data['domain']);
// define('WECHAT_TOKEN', $site_data['token']);
// define('ENCODING_AES_KEY', $site_data['ENCODING_AES_KEY']);
// define("WECHAT_APPID", $site_data['appid']);
// define("WECHAT_APPSECRET", $site_data['appsecret']);
