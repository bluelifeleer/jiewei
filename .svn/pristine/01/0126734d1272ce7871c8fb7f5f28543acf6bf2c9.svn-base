...
(function () {
   ...
   // window.UEDITOR_HOME_URL = "/resource/js/ueditor/"
    ...
    var date = new Date();
    var timeValue = "";
        timeValue = date.getYear()+"/"+(date.getMonth()+1)+"/"+date.getDate()+"/";
    window.UEDITOR_CONFIG = {
        ...
        , serverUrl: "http://res.zj3w.net/controller.php?path=/"+UPpath+"/"+timeValue
        ...
        , toolbars: [[
            ...
            'insertimage', 'emotion', 'insertcode', 'pagebreak', 'background', '|',
