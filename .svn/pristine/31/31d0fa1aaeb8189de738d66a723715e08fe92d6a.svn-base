...
class orderActionDao extends Dao
{
    public $table_name = 'order_action';
    private $fields = "action_id,order_id,action_username,order_status,shipping_status,pay_status,action_place,action_note,log_time";
    /**
     * 添加一条记录
     * @param Array $data
     */
     ...
     * LIMIT $num,$offset
     */
    public function lists($where, $offset = 15, $num = 0, $sortname = 'action_id', $sortorder, $fileds) {
        return $this->dao->db->get_all($this->table_name, $offset, $num, $where, $sortname, $sortorder, $fileds);
    }
