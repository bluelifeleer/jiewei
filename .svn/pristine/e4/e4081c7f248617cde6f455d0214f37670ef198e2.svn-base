...
<html>
    ...
    <body>
        <!-- page 容器 -->
        <div class="page" id="page-present-manner-lists">
            <!-- 标题栏 -->
            <header class="bar bar-nav">
                <a class="pull-left back" href="present_manner_list.php">
                    <i class="icon iconfont fs13 mar0 white">&#xe61b;</i>
                </a>
                <h1 class="title">提现记录</h1>
                <a class="pull-right" href="present_record.php">
                    <i class="icon iconfont fs10 mar0 white">提现方式</i>
                </a>
            </header>
            ...
            <div class="infinite-scroll-preloader">
                <div class="preloader bgnone"></div>
