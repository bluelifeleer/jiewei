    ...
    public function login() {
        ...
        if (isset($_POST['dosubmit'])) {
            ...
            if (is_array($islogin) && count($islogin) > 1) {
                ...
                $this->getUtil('cookie')->set('admin_userid', $islogin['userid'], $cookie_time);
                $this->getUtil('cookie')->set('admin_username', $islogin['username'], $cookie_time);
                $this->getUtil('cookie')->set('admin_role', $islogin['role'], $cookie_time);
