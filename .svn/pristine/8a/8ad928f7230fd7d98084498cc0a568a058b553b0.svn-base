...
<html>
	...
	<body>
    <div class="page" id="page-product-content">
		      <!--头部-->
		      <header class="bar bar-nav">
						<a class="pull-left back" id="back" href="javascript:void(0);">
							<i class="icon iconfont mar0 white fs13">&#xe61b;</i>
						</a>
						<h1 class="title white"><span>图文详情</span></h1>

						<span class="pull-right product-content-goto-cart">
							<i class="icon iconfont mar0 white fs13">&#xe605;</i>
						</span>
		      </header>
			<!--工具栏-->
			<nav class="bar bar-tab">
				...
				<!--<a href="javascript:void(0);" class="w10b tab-item  collection-button">
					<i class="iconfont block">&#xe616;</i>
					<span class="block fs06">收藏</span>
				</a>-->
				<div  class="w40b tab-item  bgcF3720E white fs06  open-popup-but" data-fn="add-cart" style="color:#FFF;cursor: pointer;">加入购物车</div>
				<div  class="w40b tab-item  fs06 bgcFF3200 white open-popup-but" data-fn="new-shop" style="color:#FFF;cursor: pointer;">立即购买</div>
			</nav>
      <!--内容-->
      <div id="product-contenter" class="content">
      	<div id="product_content">
			...
			<!--悬浮to-top-->
			<div  id="go-to-top-block" class="block c5F646E w40 h40 borrad50" style="position:fixed;right:0.7rem;bottom:5rem;cursor: pointer;">
				<div class="go-to-top-mask-layer w40 h40 borrad50" style="position:absolute;left:0rem;top:0rem;"></div>
				<i class="iconfont w40 h40 mart5  block" style="position:absolute;left:-0.6rem;top:0rem;">&#xe636;</i>
				<!-- <span class="block w50 h50 mart25 fs06 txac"  style="position:absolute;left:0rem;top:0rem;">顶部</span> -->
			</div>
    </div>
  </body>
