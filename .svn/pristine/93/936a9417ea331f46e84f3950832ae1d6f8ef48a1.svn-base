...
<html>
	...
	<body>
    	<!-- page 容器 -->
		<div class="page" id="page-modif" data-page-fn="qq">
			<!-- 标题栏 -->
			<header class="bar bar-nav">
				<h1 class="title">修改QQ号</h1>
				<a class="pull-left external" href="userinfo.php">
					<i class="icon iconfont mar0 white">&#xe64c;</i>
				</a>
			</header>
			<div class="content pad15">
				<input class="w100b bor1 bce6 bgfff pad10" id="qq" type="text" placeholder="输入QQ号">
				<p data-modif-type="qq" id="modif-but" class="block mar0 mart10 borrad5 marauto white w100b h50 lh50 txac bgfa6a0b" style="line-height:50px;cursor:pointer;">保存</p>
			</div>
		</div>
	</body>
