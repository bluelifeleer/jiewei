...
<html>
	...
	<body>
    <!-- page 容器 -->
		<div class="page" id="page-shop-address">
			<!-- 标题栏 -->
        ...
        <div class="w100b h50 lh50 borb1 bcc1c1c1 bgfff">
          <span class="block fll w25b h50 lh50">&nbsp;&nbsp;&nbsp;&nbsp;所在区域</span>
          <input value="请选择所在地区" name="shop_area" id="picker" class="block fll w65b h48 lh50 bor0" />
          <span class="block fll w10b h50 lh50 iconfont mar0">&#xe63d;</span>
        </div>
        <div class="w100b h50 lh50 borb1 bcc1c1c1 bgfff">
          <span class="block fll w25b h50 lh50">&nbsp;&nbsp;&nbsp;&nbsp;详细地址</span>
          <input type="text" class="block fll w70b h48 lh50 bor0" name="shop_address" value="" id="shop_address" />
        </div>
      </div>
    </div>
  </body>
