...
<html>
	...
	<body>
		<!-- page 容器 -->
		<div class="page" id="soft-about">
			<!-- 标题栏 -->
			<header class="bar bar-nav">
				<h1 class="title">云兆云商</h1>
				<a class="pull-left back " >
					<i class="icon iconfont mar0 white">&#xe61b;</i>
				</a>
			</header>
			<div class="content qr">
				<img src="/sources/images/about_01.jpg" class="w100b" alt="">
				<img src="/sources/images/about_02.jpg" class="w100b" alt="">
				<img src="/sources/images/about_03.jpg" class="w100b" alt="">
			</div>
		</div>
	</body>
