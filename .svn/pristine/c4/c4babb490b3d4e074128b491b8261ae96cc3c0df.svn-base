	...
	<body>
		...
		<div class="page">
			...
			<div class="content pad15">
				<input class="w100b bor1 bce6 bgfff pad10" id="username" type="text" placeholder="手机号/帐号">
				<p class="mar0 mart10"><a class="button button-big button-fill bgc6 " href="">发送验证码(60)</a></p>
				<p class="mar0 mart10"><a class="button button-big button-fill bgfa6a0b " href="modify_pass.php">验证</a></p>
			</div>
		</div>
	</body>
