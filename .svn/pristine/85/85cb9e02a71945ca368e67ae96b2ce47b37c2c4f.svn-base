...
<html>
    ...
    <body>
        <!-- page 容器 -->
        <div class="page" id="page-present-record">
            <!-- 标题栏 -->
            <header class="bar bar-nav">
                <a class="pull-left back" href="present_manner.php">
                    <i class="icon iconfont fs13 mar0 white">&#xe61b;</i>
                </a>
                <h1 class="title">提现方式</h1>
                <a class="pull-right" href="present_record_add.php">
                    <i class="icon iconfont fs13 mar0 white">&#xe603;</i>
                </a>
            </header>
