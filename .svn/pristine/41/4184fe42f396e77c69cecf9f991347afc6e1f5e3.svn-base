                    ...
                    if (lists['code'] == 0) {
                        if (lists['data'][1] > 0) {
                            ...
                            $.each(lists['data'][0], function(order_id, item) {
                                ...
                                operation = '<a class="flr bor1 bce6 txac borrad5 marl10 padt4 padb4 padl10 padr10 c666 fs06" href="shop_Order_Info.php?order_id=' + order_id + '">查看订单详情</a>';
                                    ...
                                    if (orderinfo.from_id == 1 && orderinfo.shop_id > 1) { //表示平台导入的商品
                                        ...
                                        var icon = '<span style="display:block;width:80px;height:40px;position:absolute;left:0px;top:0;"></span>';
                                         ...
                                         if(parseInt(orderinfo.goods_status) == 2){
                                            operationdeliver ='<a class="flr bor1 bce6 txac borrad5 marl10 padt4 padb4 padl10 padr10 c666 fs06"  href="delivery.php?order_id='+ order_id +'&pro_id='+orderinfo['goods_id']+'">发货</a>';
                                         }
                                    }
           ...
           default://确认收货
             ...
             $.ajax({
               ...
               success : function(res){
                 ...
                 if(res.code == 0){
                   $.toast('您的订单已确认收货');
                   $.router.loadPage('order.php?order_type=4');
                 }else{
                   $.toast('订单确认收货失败');
                 }
               },
