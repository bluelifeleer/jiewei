	...
	<body>
		...
		<div class="page" id="page-safety">
			...
			<header class="bar bar-nav">
				...
				<h1 class="title">帐号安全</h1>
			</header>
			<!-- 这里是页面内容区 -->
			<div class="content" style="background-color:#fff">
				<div class="content-padded fs07" style="line-height:2rem;border-bottom:1px solid #c1c1c1;">
					<a class="c666 " href="modify_pass.php">
						<div id="modify-pass-block" class="row">
							<div class="col-50">修改密码</div>
							<div class="col-50">
								<i class="flr icon iconfont mar0 fs09 cccc">&#xe600;</i>
							</div>
						</div>
					</a>
				</div>
