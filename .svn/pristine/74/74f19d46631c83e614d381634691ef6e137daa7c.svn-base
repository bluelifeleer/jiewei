...
<html>
    ...
    <body>
        <!-- page 容器 -->
        <div class="page" id="page-shop-product-classify">
            <!-- 标题栏 -->
            ...
            <div class="content bgEEEEEE">
                <div class="w100b bgfff">
                     ...
                     <a href="shop_product_manage.php?fromid=0" class="black">
                       <div class="edit-shop-info-title w100b h50 lh50 borb1 bce6">
                       
                            <span class="marl20">
                            添加自营产品
                            </span>
                            <span class="iconfont-right flr iconfont marr10" id="Shopcounts">
                                &#xe600;
                            </span>
                    ...
                    <a href="shop_product_manage.php?fromid=1" class="black">
                       <div class="edit-shop-info-title w100b h50 lh50 borb1 bce6">
                       
                            <span class="marl20">
                            平台导入商品
                            </span>
                            <span class="iconfont-right flr iconfont marr10" id="platforms">
                                &#xe600;
                            </span>
