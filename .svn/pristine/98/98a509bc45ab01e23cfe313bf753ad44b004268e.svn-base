...
<html lang="en">
    ...
    <body>
        <div class="page" id="page-add-goods">
            <header class="bar bar-nav">
                <a class="pull-left back back" href="apply_shop_create_category.php">
                  ...
                  <ul id="cate-list-block">
                    <!--li class="item-content">
                      ...
                      <div class="item-inner">
                        <div class="_catename item-title">栏目aaaa</div>
                        <div class="item-after">导入商品</div>
                      </div>
                    </li>


                    <a href="shop_add_product.php" class="external">
                        <li class="item-content">
                          <div class="item-media"><i class="icon icon-right"></i></div>
                          <div class="item-inner">
                            <div class="_catename item-title">栏目b</div>
                    ...
                    <a href="shop_add_product.php" class="external">
                        <li class="item-content">
                          ...
                          <div class="item-inner">
                            <div class="_p_catename item-title">子栏目b</div>
                            <div class="item-after"><span class="badge">5</span></div>
                          </div>
                        </li>
                     </a>
                    ...
                    <li class="item-content">
                      <div class="item-media"><i class="icon icon-right"></i></div>
                      <div class="item-inner">
                        <div class="_catename item-title">栏目C</div>
                        <div class="item-after"><span class="badge">9</span></div>
                      </div>
                    </li-->

                  </ul>
                  <div class="list-block-label">当前一共导入<font id="pro_number">0</font>款产品
                  <font class="pad30"><br/><b>注:1S-10S为产品利润等级。<br/>
                                  解释:1S=利润10%;2S=利润20%;3S=利润30%;以此类推</b>
                  </font>
                  </div>
                  <div id="open-shop" class="block w80b marauto h50 lh50 txac white bgCB1408 mart20 borrad5 black">开通店铺</div>
                </div>
            </div>
            ...
            <nav class="bar bar-tab">
                ...
                <a class="tab-item external" href="#">
                    <i class="icon iconfont">&#xe66f;</i>
                    <span class="tab-label">界微</span>
                </a>
                <a class="tab-item external" href="cart.php">
                    <i class="icon iconfont">&#xe62e;</i>
                    <span class="tab-label">购物车</span>
                </a>
                <a class="tab-item external" href="order.php">
                    <i class="icon iconfont">&#xe661;</i>
