 ...
 * @Last Modified time: 2015-12-24 21:39:07
 */
class servicesService extends Service{
    ...
    public function __construct() {
        parent::__construct();
        //获取Dao
        $this->DB = InitPHP::getDao('services');
    }
     ...
     */
    public function lists($where = array(), $offset = 0, $num = 1000, $order = 'groupid', $sort = 'asc', $key = 'groupid', $fileds = '*') {
