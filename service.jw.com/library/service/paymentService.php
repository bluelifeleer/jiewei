 ...
 * @Last Modified time: 2015-12-29 15:24:23
 */
class paymentService extends Service{
    ...
    public function __construct() {
        parent::__construct();
        //获取Dao
        $this->DB = InitPHP::getDao('payment');
    }
     ...
     */
    public function lists($where = array(), $offset = 0, $num = 1000, $order = 'pay_id', $sort = 'asc', $key = 'pay_id', $fileds = '*') {
