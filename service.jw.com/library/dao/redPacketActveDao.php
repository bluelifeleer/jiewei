...
class redPackeActivetDao extends Dao {
	public $table_name = 'red_packet_active';
	private $fields = 'id,no,title,remark,amount,addtime,endtime,userid,status,admin_note,type,pro_id';
