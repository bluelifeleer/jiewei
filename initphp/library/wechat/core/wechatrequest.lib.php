    ...
    public static function switchType(&$request){
        ...
        switch ($request['msgtype']) {
            ...
            case 'text':
                ...
                $data = ResponsePassive::forwardToCustomService($request['fromusername'], $request['tousername']);
                break;
            //图像
            case 'image':
